...
\item
  ...
  \ul{main memory}: \includegraphics{Pasted image 20241119212829.png}
\item
...
\item
  ...
  \includegraphics{Pasted image 20241119213521.png}\includegraphics{Pasted image 20241119213547.png}\includegraphics{Pasted image 20241119213613.png}
\end{itemize}
...
\item
  ...
  \includegraphics{Pasted image 20241120233720.png} \^{}\ul{Base} and
...
\item
  ...
  \includegraphics{Pasted image 20241120234121.png}
\end{itemize}

\subsubsection*{Multiple-Partition Allocation}

\includegraphics{Pasted image 20241120234217.png}\includegraphics{Pasted image 20241120234301.png}

\subsubsection*{Fragmentation}

\includegraphics{Pasted image 20241120234354.png} \#\# Swapping
\includegraphics{Pasted image 20241120234424.png}

\section*{Virtual Memory}

\includegraphics{Pasted image 20241120234652.png}\includegraphics{Pasted image 20241120234731.png}

\subsection*{Paging}

\includegraphics{Pasted image 20241120234802.png}\includegraphics{Pasted image 20241120234958.png}\includegraphics{Pasted image 20241121002233.png}
...
\includegraphics{Pasted image 20241121001555.png}\includegraphics{Pasted image 20241121001607.png}
...
\includegraphics{Pasted image 20241121002445.png}\includegraphics{Pasted image 20241121002517.png}
...
\ul{page table} \includegraphics{Pasted image 20241121014235.png} This
...
\item
  ...
  \item
    ...
    \includegraphics{Pasted image 20241121014705.png}
  \end{itemize}
\end{itemize}

\paragraph*{Performance: Effective Access Time}

\includegraphics{Pasted image 20241121014814.png} \^{}this formula is
for \ul{one-level tables} where \ul{memory cycle time} \iMbox{M} is
\iMbox{M=1 \mu sec}, but we can generalize to to \ul{\iMbox{n}-level
tables}
...
\includegraphics{Pasted image 20241121015119.png}\includegraphics{Pasted image 20241121015142.png}\includegraphics{Pasted image 20241121015202.png}

\paragraph*{Three-Level Page Tables}

\begin{figure}
\centering
\includegraphics{Pasted image 20241121015246.png}
\caption{400}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Pasted image 20241121015455.png}
\caption{450}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Pasted image 20241121015511.png}
\caption{450}
\end{figure}

\subsection*{Shared Memory}

\includegraphics{Pasted image 20241121043002.png}\includegraphics{Pasted image 20241121043052.png}

\subsection*{Segmentation \& Hybrid Paging/Segmentation Approaches}

\includegraphics{Pasted image 20241121043422.png}\includegraphics{Pasted image 20241121043557.png}

\subsection*{Virtual Memory Tricks}

\subsubsection*{Copy On Write (COW)}

\includegraphics{Pasted image 20241121051904.png}\includegraphics{Pasted image 20241121051922.png}\includegraphics{Pasted image 20241121051959.png}
...
\includegraphics{Pasted image 20241121051008.png}\includegraphics{Pasted image 20241121051024.png}

\subsection*{Page Faults}

\includegraphics{Pasted image 20241121051211.png}\includegraphics{Pasted image 20241121051229.png}

\subsection*{Performance of Demand Paging}

\includegraphics{Pasted image 20241121051359.png}\includegraphics{Pasted image 20241121051441.png}

\subsection*{Page Replacement}

\begin{figure}
\centering
\includegraphics{Pasted image 20241121052234.png}
\caption{450}
\end{figure}

\subsubsection*{Basic Page Replacement Strategy}

\includegraphics{Pasted image 20241121052331.png}\includegraphics{Pasted image 20241121052345.png}

\subsubsection*{Page replacement algorithms}

\begin{figure}
\centering
\includegraphics{Pasted image 20241121052422.png}
\caption{450}
\end{figure}

\paragraph*{First-In-First-Out (FIFO) Algorithm}

\includegraphics{Pasted image 20241121052634.png}\includegraphics{Pasted image 20241121052741.png}\includegraphics{Pasted image 20241121052754.png}

\paragraph*{Optimal Algorithm}

\begin{figure}
\centering
\includegraphics{Pasted image 20241121052828.png}
\caption{450}
\end{figure}
...
\includegraphics{Pasted image 20241121052855.png}\includegraphics{Pasted image 20241121052941.png}\includegraphics{Pasted image 20241121053003.png}
...
\begin{figure}
\centering
\includegraphics{Pasted image 20241121053246.png}
\caption{400}
\end{figure}
...
\includegraphics{Pasted image 20241121054055.png}
\includegraphics{Pasted image 20241121054205.png}\includegraphics{Pasted image 20241121054226.png}\includegraphics{Pasted image 20241121054508.png}
...
\item
  ...
  \item
    ...
    \includegraphics{Pasted image 20241121053818.png}
  \end{itemize}
\end{itemize}
...
\begin{figure}
\centering
\includegraphics{Pasted image 20241121053938.png}
\caption{600}
\end{figure}
...
\includegraphics{Pasted image 20241121043955.png}\includegraphics{Pasted image 20241121044018.png}

\subsection*{Linux: Paging}

\begin{figure}
\centering
\includegraphics{Pasted image 20241121044109.png}
\caption{500}
\end{figure}

\subsection*{Linux: Page Replacement}

\includegraphics{Pasted image 20241121054602.png}\includegraphics{Pasted image 20241121054630.png}
...
\includegraphics{Pasted image 20241121045915.png}\includegraphics{Pasted image 20241121045936.png}\includegraphics{Pasted image 20241121050027.png}
\includegraphics{Pasted image 20241121050057.png} Essentially you do it
like this:
